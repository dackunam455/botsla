              ...
              if (reklam.some(word => msg.content.toLowerCase().includes(word))) {
                try {
                  if (!msg.member.hasPermission("MANAGE_GUILD")) {
                    ...
                    .setDescription("Public-Bot Reklam sistemi, " + `***${msg.guild.name}***` + " adlı sunucunuzda reklam yakaladım.")
...
client.on("userUpdate", async(eski, yeni) => {
  ...
  if(!yeni.username.includes("⛧") && client.guilds.get("704437611489394689").members.get(yeni.id).roles.has("712610839278125078")) {
     client.guilds.get("704437611489394689").members.get(yeni.id).removeRole("712610839278125078")
     client.channels.get('712676106033168434').send(`:broken_heart: ${yeni}, ⛧ tagını çıkardı!`)
    }
     if(yeni.username.includes("⛧") && !client.guilds.get("704437611489394689").members.get(yeni.id).roles.has("712610839278125078")) {
      client.channels.get('712676106033168434').send(`:heart: ${yeni}, ⛧ tagını aldı!`)
...
client.on('guildMemberRemove',async (member) =>{
  if(member.guild.id !='704437611489394689') return
  const kanal = `SON GİDEN KİŞİ ♡● ${member.user.username}`
